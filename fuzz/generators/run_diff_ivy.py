...
class GeneratorDiffIvy(GeneratorBase):
    ...
    def TestOneProtoInput(self, msg):
        ...
        data["generation_result_adder"] = proto_converter.result
        ...
        message = {
            ...
            "generation_result_adder": proto_converter.result,
...
generator = GeneratorDiffIvy(NaginiConverter)
